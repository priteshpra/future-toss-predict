...
function team_aliases(): array
{
    return [
        ...
        'dehradun' => ['dehradunwarriors'],
        'dehradunwarriors' => ['dehradun'],
        'pithoragarh' => ['pithoragarhhurricanes'],
        'pithoragarhhurricanes' => ['pithoragarh'],
        'bageshwar' => ['bageshwaraerial'],
        'bageshwaraerial' => ['bageshwar'],
        'mussoorie' => ['mussooriequeens'],
        'mussooriequeens' => ['mussoorie'],
        'haridwar' => ['haridwarelmas', 'haridwarspringelmas'],
        'haridwarelmas' => ['haridwar', 'haridwarspringelmas'],
        'nainital' => ['nainitaltigers'],
        'nainitaltigers' => ['nainital'],
